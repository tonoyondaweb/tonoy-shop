...
const Container = tw.div`h-full border border-biege-4 transition-all hover:bg-biege-2/50 hover:-translate-y-1 hover:shadow-biege-4/50 hover:shadow-[7px_7px_0_-2px]`;
const ProductImage = tw(Image)`aspect-square object-cover`;
