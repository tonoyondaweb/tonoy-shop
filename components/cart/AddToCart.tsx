...
const Container = tw.div`w-full max-w-[400px] mx-auto flex border bg-biege-2 border-biege-4 sticky bottom-6 text-lg gap-x-3 p-3 shadow-[5px_5px_0_-1px] shadow-biege-4 md:static md:mt-5`;
